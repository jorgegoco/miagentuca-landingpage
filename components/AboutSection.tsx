      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="text-center md:text-left">
            <h2 className="text-3xl font-bold text-navy-900 mb-2">Jorge González</h2>
            <p className="text-electric-600 font-semibold mb-6">Consultor de IA y Desarrollador de Agentes</p>
            
            <p className="text-slate-600 text-lg leading-relaxed mb-8">
              "La tecnología avanza rápido, pero mi enfoque sigue siendo el mismo: <span className="text-navy-900 font-medium">honestidad y resultados</span>. Ayudo a empresas reales a usar la IA más avanzada de forma práctica."
            </p>
