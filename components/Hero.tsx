...
const Hero: React.FC<HeroProps> = ({ onOpenModal }) => {
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden bg-navy-900">
      ...
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-electric-600/20 rounded-full blur-3xl pointer-events-none animate-pulse" />
      <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-blue-900/20 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute top-1/3 right-1/3 w-[400px] h-[400px] bg-purple-600/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-slate-300 max-w-2xl mx-auto mb-16 leading-relaxed">
            Implemento <span className="text-white font-semibold">Agentes de IA</span> que gestionan procesos completos en tu
            empresa: desde reclamar facturas hasta comparar presupuestos.
            Funcionan <span className="text-electric-400">24/7</span>, no se cansan y no cometen errores.
          </p>
          ...
          <div className="relative inline-block">
            ...
            <p className="relative text-xl md:text-2xl font-medium text-slate-300 italic tracking-wide">
              ...
              <span className="text-electric-400 font-bold drop-shadow-[0_0_10px_rgba(56,189,248,0.3)]">
                vendemos tiempo
              </span>
              ."
            </p>
