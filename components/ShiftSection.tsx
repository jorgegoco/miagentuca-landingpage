      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-navy-900 mb-4">
            La diferencia entre <span className="text-slate-400 line-through">Automatizar</span> y <span className="text-electric-600">Delegar</span>
          </h2>
          <p className="text-slate-600 max-w-2xl mx-auto">
            La automatización clásica te ahorra clics. La IA Agéntica te ahorra decisiones.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            ...
            <h3 className="text-xl font-bold text-slate-500 mb-4">Antes (Automatización Clásica)</h3>
            <p className="text-slate-600 leading-relaxed">
              "La IA te escribe el borrador del email, <strong className="text-slate-800">tú lo revisas</strong>, <strong className="text-slate-800">tú lo editas</strong> y <strong className="text-slate-800">tú lo envías</strong>."
            </p>
          ...
          >
            ...
            <p className="text-navy-800 leading-relaxed font-medium">
              "El Agente lee el correo, busca el dato en tu sistema, decide la respuesta correcta, te pone en copia y lo archiva. <span className="text-electric-600 font-bold">Tú solo supervisas.</span>"
            </p>
