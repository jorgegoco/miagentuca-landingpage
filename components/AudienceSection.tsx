              ...
              {[
                {
                  ...
                  desc: "Identificamos dónde pierdes más tiempo.",
                },
                {
                  title: "Diseño del Agente (Piloto)",
                  desc: "Creamos un prototipo funcional en días.",
                },
                {
                  title: "Despliegue y Supervisión",
                  desc: "Lo integramos y verificamos que rinda.",
                },
              ].map((step, i) => (
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-slate-50 rounded-lg border border-slate-100 mt-6">
                  ...
                  <p className="font-mono text-xs text-slate-500">
                    {"> Iniciando análisis de facturas..."}
                    <br />
                    {"> 45 documentos procesados."}
                    <br />
